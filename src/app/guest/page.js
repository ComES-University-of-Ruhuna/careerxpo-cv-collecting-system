...
import { TIME_ZONE_LABEL } from '@/lib/date-time';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="datetime-local" name="deadline" aria-label={`Deadline (${TIME_ZONE_LABEL})`} title={TIME_ZONE_LABEL} value={form.deadline} onChange={handleChange} className="w-full border border-gray-300 rounded-lg pl-9 pr-3 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                    </div>
                  </div>
                </div>
              </div>
